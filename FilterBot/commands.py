...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      ...
      InlineKeyboardButton('Channel', url='t.me/watchnowin'),
      InlineKeyboardButton('Support', url='t.me/itsriyas')
      ]]
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('Github', url='https://github.com/KingstarStudios'),
                   InlineKeyboardButton('Admin', url='t.me/itsriyas') ],
